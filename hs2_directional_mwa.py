...
def phase3_visualise(surface, vessels, vnames, tumors, centroids,
    ...
    # ── Legend — pinned to far-right strip, clear of 3D reconstruction ──
    # loc=(x, y) = normalised lower-left corner of the legend box.
    # x=0.78 puts it in the rightmost ~22% where the scalar bars already
    # live; y=0.52 stacks it above the scalar bars so nothing overlaps.
    plotter.add_legend(
        loc=(0.78, 0.52),
        size=(0.21, 0.46),
